...
--5 Find any car trip more expensive than a trip taken on a train in the same state or outside
the country.
...
--8 Find those pair of trips in the same state with the same mode of travel. List such pairs
...
--9 Find a state in which trips have been taken by all three modes of transportation: train,
plane, and car.
